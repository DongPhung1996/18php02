                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-10">
                                    <form action="user.php?controller=user&action=edit_info_user" role="form" method="post">
                                        <div class="row">
                                            <div class="col-lg-6">
                                        ...
                                        <div align="center">
                                            <button type="submit" class="btn btn-default" name="edit_info_user">Sửa</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
